...
_s(AuthGuard, "QdHvQ10z/NERuhWbI2JFYU/xEOs=", false, function() {
    return [
...
_s(PlateEditor, "BRVgKWLgQXx+GZm+hQXSzJNGHHk=");
_c = PlateEditor;
var _c;
    ...
    const saveMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ChapterEditPage.useMutation[saveMutation]": async (data)=>{
                if (isNewChapter) {
                    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/chapters/', {
                        ...data,
                        course: courseId
                    });
                    return response.data;
...
_s(ChapterEditPage, "QfNHDhT/o+tVGhhdY5uduoNq2Jg=", false, function() {
    return [
...
//# sourceMappingURL=_87f40e96._.js.map
...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/auth/register/', {
...
_s(RegisterPage, "dvTmqYv7o3Si/jCpfesVfarRlIs=", false, function() {
    return [
...
//# sourceMappingURL=src_d08513f7._.js.map
...
function ProfilePage() {
    ...
    const { updateUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$authStore$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])();
    ...
    const { data: user, isLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "ProfilePage.useQuery": async ()=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/profile/');
                setFormData({
    ...
    const updateMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "ProfilePage.useMutation[updateMutation]": async (data)=>{
                const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put('/profile/', {
                    email: data.email,
        ...
        onSuccess: {
            "ProfilePage.useMutation[updateMutation]": (data)=>{
...
_s(ProfilePage, "xuWd5XQleSpJ+bRqdvT1PajBcoY=", false, function() {
    return [
...
_c1 = ProfilePageWrapper;
var _c, _c1;
__turbopack_context__.k.register(_c, "ProfilePage");
__turbopack_context__.k.register(_c1, "ProfilePageWrapper");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_5d55676d._.js.map